...
export const metadata: Metadata = {
  title: {
    default: "SangYun Blog",
    template: "%s | SangYun Blog",
  },
    ...
    <html lang="ko">
      ...
      >
        ...
        <header className="border-b border-gray-100">
          <nav className="max-w-3xl mx-auto py-5 flex items-center justify-between">
            <Link
              href="/"
        ...
        <footer className="border-t border-gray-100 mt-20">
          <div className="max-w-3xl mx-auto py-8 text-center text-sm text-gray-400">
